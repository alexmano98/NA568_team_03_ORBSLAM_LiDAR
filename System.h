...
public:
    ...
    Sophus::SE3f TrackStereo(bool modified, std::string litamin_file, const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<IMU::Point>& vImuMeas=vector<IMU::Point>(), string filename="");
;
